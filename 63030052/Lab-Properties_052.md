...
![image](https://user-images.githubusercontent.com/92083472/167295811-f58b2bea-3edc-4254-bdc6-2956aee0af24.png)
### คำถาม ###
1. โปรแกรมนี้ทำงานได้หรือไม่ ถ้าไม่ได้ ต้องแก้ไขอย่างไร<br>
`โปรแกรมสามารถรันได้`<br>
2. ทำไมเราต้องมี properties ทั้งๆ ที่มี fields อยู่แล้ว แค่ประกาศเป็น public ก็ใช้งานจากที่ไหนก็ได้<br>
`เราสามารถกำหนดให้ อ่านอย่างเดียว หรือเขียนอย่างเดียว หรืออ่านและเขียนได้`<br>
...
![image](https://user-images.githubusercontent.com/92083472/167295967-3e5b6747-db8c-47f8-b84d-a175c579a2ea.png)
...
![image](https://user-images.githubusercontent.com/92083472/167296096-c343564d-f7e0-4502-87d6-0b2111d20682.png)
...
### คำถาม ###
1. โปรแกรมนี้ทำงานได้หรือไม่ ถ้าไม่ได้ เกิดจากอะไร<br>
`โปรแกรมไม่สามารถรันได้ เพราะ เป็น property แบบ อ่านได้อย่างเดียว`<br>
