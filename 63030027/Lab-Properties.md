...
![image](https://user-images.githubusercontent.com/91043042/169658192-44ae34df-43f8-4bcc-be98-480f1ee5568f.png)
...
```
เพราะ properties สามารถกำหนดได้ว่าจะสามารถทำให้อ่านได้อย่างเดียว เขียนอย่างเดียว หรือทั้งเขียนและอ่านได้
```
...
![image](https://user-images.githubusercontent.com/91043042/169658501-e9d5079e-c6a2-41a4-abaf-3285c5113b95.png)
...
![image](https://user-images.githubusercontent.com/91043042/169658613-285c9c76-0f6d-4bf0-bf13-5ba6a560a580.png)
...
![image](https://user-images.githubusercontent.com/91043042/169658733-efaab746-dfed-4857-8855-ba051ba6bb3d.png)


### คำถาม ###
1. โปรแกรมนี้ทำงานได้หรือไม่ ถ้าไม่ได้ เกิดจากอะไร
```
กำหนด property ผิด เปลื่ยนเป็นแบบ write จึงจะแก้ไขได้
```
...
![image](https://user-images.githubusercontent.com/91043042/169658921-2bf68f68-2580-49fb-8bba-f2b8758b3a68.png)
...
![image](https://user-images.githubusercontent.com/91043042/169659052-3aa23f10-e160-406b-b48f-097e88cd26cd.png)
