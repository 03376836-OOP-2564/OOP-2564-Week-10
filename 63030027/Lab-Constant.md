...
![image](https://user-images.githubusercontent.com/91043042/169656716-03cb0639-e3fe-42e5-b863-24ffe19dc3f3.png)
...
![image](https://user-images.githubusercontent.com/91043042/169656767-3053571a-4c51-4560-ac27-9a388436d60b.png)
...
```
ข้อที่3 ไม่สามารถรันได้
```
3. ถ้าจะให้แก้ไขโปรแกรม ต้องแก้ที่จุดไหน อย่างไร
```
เปลื่ยนตัวแปร จาก public const double PI = 3.14; เป็น public double PI = 3.14;
```
